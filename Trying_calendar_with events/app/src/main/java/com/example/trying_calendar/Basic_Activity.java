...
public class Basic_Activity extends Base_Activity {
    ...
    public void onEventClick(WeekViewEvent event, RectF eventRect) {
        ...
        Intent intent = new Intent(Basic_Activity.this, View_Event_Details.class);
    ...
    public void onEmptyViewLongPress(Calendar time) {
        ...
        Intent intent = new Intent(Basic_Activity.this, Create_Event.class);
        startActivity(intent);
    }
